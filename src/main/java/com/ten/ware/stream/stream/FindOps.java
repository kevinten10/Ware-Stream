    ...
    private abstract static class FindSink<T, O> implements TerminalSink<T, O> {
        ...
        static final class OfRef<T> extends FindOps.FindSink<T, Optional<T>> {
            ...
            static final TerminalOp<?, ?> OP_FIND_FIRST = new FindOp<>(true,
                    ...
                    Optional::isPresent, FindOps.FindSink.OfRef::new);
        ...
        static final class OfInt extends FindOps.FindSink<Integer, OptionalInt>
            ...
            static final TerminalOp<Integer, OptionalInt> OP_FIND_FIRST = new FindOp<>(true,
                    ...
                    OptionalInt::isPresent, FindOps.FindSink.OfInt::new);
        ...
        static final class OfLong extends FindOps.FindSink<Long, OptionalLong>
            ...
            static final TerminalOp<Long, OptionalLong> OP_FIND_FIRST = new FindOp<>(true,
                    ...
                    OptionalLong::isPresent, FindOps.FindSink.OfLong::new);
        ...
        static final class OfDouble extends FindOps.FindSink<Double, OptionalDouble>
            ...
            static final TerminalOp<Double, OptionalDouble> OP_FIND_FIRST = new FindOp<>(true,
                    ...
                    OptionalDouble::isPresent, FindOps.FindSink.OfDouble::new);
