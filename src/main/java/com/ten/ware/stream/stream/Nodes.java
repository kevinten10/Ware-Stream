...
final class Nodes {
    ...
    private abstract static class EmptyNode<T, T_ARR, T_CONS> implements Node<T> {
        ...
        private static final class OfInt
                extends Nodes.EmptyNode<Integer, int[], IntConsumer>
        ...
        private static final class OfLong
                extends Nodes.EmptyNode<Long, long[], LongConsumer>
        ...
        private static final class OfDouble
                extends Nodes.EmptyNode<Double, double[], DoubleConsumer>
    ...
    private abstract static class InternalNodeSpliterator<T,
        ...
        private static final class OfRef<T>
                extends Nodes.InternalNodeSpliterator<T, Spliterator<T>, Node<T>> {
        ...
        private abstract static class OfPrimitive<T, T_CONS, T_ARR,
                ...
                extends Nodes.InternalNodeSpliterator<T, T_SPLITR, N>
    ...
    private abstract static class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>,
                                                     K extends Nodes.SizedCollectorTask<P_IN, P_OUT, T_SINK, K>>
        ...
        static final class OfRef<P_IN, P_OUT>
                extends Nodes.SizedCollectorTask<P_IN, P_OUT, Sink<P_OUT>, OfRef<P_IN, P_OUT>>
                implements Sink<P_OUT> {
        ...
        static final class OfInt<P_IN>
                extends Nodes.SizedCollectorTask<P_IN, Integer, Sink.OfInt, OfInt<P_IN>>
            ...
            OfInt(Nodes.SizedCollectorTask.OfInt<P_IN> parent, Spliterator<P_IN> spliterator,
                  long offset, long length) {
                super(parent, spliterator, offset, length, parent.array.length);
                this.array = parent.array;
            }
            ...
            @Override
            Nodes.SizedCollectorTask.OfInt<P_IN> makeChild(Spliterator<P_IN> spliterator,
                                                           long offset, long size) {
        ...
        static final class OfLong<P_IN>
                extends Nodes.SizedCollectorTask<P_IN, Long, Sink.OfLong, OfLong<P_IN>>
            ...
            OfLong(Nodes.SizedCollectorTask.OfLong<P_IN> parent, Spliterator<P_IN> spliterator,
                   long offset, long length) {
                super(parent, spliterator, offset, length, parent.array.length);
                this.array = parent.array;
            }
            ...
            @Override
            Nodes.SizedCollectorTask.OfLong<P_IN> makeChild(Spliterator<P_IN> spliterator,
                                                            long offset, long size) {
        ...
        static final class OfDouble<P_IN>
                extends Nodes.SizedCollectorTask<P_IN, Double, Sink.OfDouble, OfDouble<P_IN>>
            ...
            OfDouble(Nodes.SizedCollectorTask.OfDouble<P_IN> parent, Spliterator<P_IN> spliterator,
                     long offset, long length) {
                super(parent, spliterator, offset, length, parent.array.length);
                this.array = parent.array;
            }
            ...
            @Override
            Nodes.SizedCollectorTask.OfDouble<P_IN> makeChild(Spliterator<P_IN> spliterator,
                                                              long offset, long size) {
    ...
    private abstract static class ToArrayTask<T, T_NODE extends Node<T>,
                                              K extends Nodes.ToArrayTask<T, T_NODE, K>>
            extends CountedCompleter<Void> {
        ...
        @SuppressWarnings("serial")
        private static final class OfRef<T>
                extends Nodes.ToArrayTask<T, Node<T>, OfRef<T>> {
        ...
        private static class OfPrimitive<T, T_CONS, T_ARR,
                ...
                extends Nodes.ToArrayTask<T, T_NODE, OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>> {
    ...
    private static class CollectorTask<P_IN, P_OUT, T_NODE extends Node<P_OUT>, T_BUILDER extends Node.Builder<P_OUT>>
        ...
        private static final class OfRef<P_IN, P_OUT>
                extends Nodes.CollectorTask<P_IN, P_OUT, Node<P_OUT>, Node.Builder<P_OUT>> {
        ...
        private static final class OfInt<P_IN>
                extends Nodes.CollectorTask<P_IN, Integer, Node.OfInt, Node.Builder.OfInt> {
        ...
        private static final class OfLong<P_IN>
                extends Nodes.CollectorTask<P_IN, Long, Node.OfLong, Node.Builder.OfLong> {
        ...
        private static final class OfDouble<P_IN>
                extends Nodes.CollectorTask<P_IN, Double, Node.OfDouble, Node.Builder.OfDouble> {
